name := "akka-dynamic-batch-onnx-gpu-bert"
...
libraryDependencies ++= Seq(
  ...
  "com.microsoft.onnxruntime" % "onnxruntime_gpu" % "1.12.0"
)
libraryDependencies ++= Seq(
  "com.robrua.nlp" % "easy-bert" % "1.0.3"
).map(x => x.exclude("org.tensorflow", "tensorflow"))

assembly / mainClass := Some("serving.http.HttpServer")
assembly / assemblyJarName := "akka-dynamic-batch-onnx-gpu-bert.jar"
